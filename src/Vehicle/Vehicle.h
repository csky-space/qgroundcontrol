...
public:
    ...
    void sendJoystickRCOverrideDataThreadSafe (float roll, float pitch, float yaw, float thrust, float gimbalPitch, float gimbalYaw, const std::array<uint8_t, 12>& rcOverrideButtons);
